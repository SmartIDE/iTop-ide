...
EOF
	...
	protected function DisplayFormTable(WebPage $oP, $aConfig, $aData)
	{
		...
		$sHtml .= "<tr $sEmptyRowStyle id=\"{$this->m_sAttCode}{$this->m_sNameSuffix}_empty_row\"><td colspan=\"".count($aConfig)."\" style=\"text-align:center;\">".Dict::S('UI:Message:EmptyList:UseAdd')."AAAAAAAAAAAAAAAAAAAAAAA</td></tr>";
		$sHtml .= "</tbody>\n";
