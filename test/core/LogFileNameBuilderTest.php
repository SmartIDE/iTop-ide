...
class LogFileNameBuilderTest extends ItopTestCase
{
	 ...
	 */
	public function GroupTestShouldRotate($sFileNameBuilderClass, $sDateModified, $sDateNow, $bExpected)
	{
	 ...
	 */
	public function GroupTestCronNextOccurrence($sFileNameBuilderClass, $sDateNow, $sExpectedOccurrence)
	{
		$oDateNow = DateTime::createFromFormat('Y-m-d H:i', $sDateNow);
