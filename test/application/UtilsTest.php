...
class UtilsTest extends \Combodo\iTop\Test\UnitTest\ItopTestCase
{
	 ...
	 */
	public function GroupTestIsMemoryLimit($expected, $memoryLimit, $requiredMemory)
	{
	 ...
	 */
	public function GroupTestRealPath($sPath, $sBasePath, $expected)
	{
	 ...
	 * @param $expected
	 */
	public function GroupTestLocalPath($sAbsolutePath, $expected)
	{
	 ...
	 */
	public function GroupTestGetAppRootUrl($sReturnValue, $sCurrentScript, $sAppRoot, $sAbsoluteUrl)
	{
