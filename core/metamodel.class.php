...
abstract class MetaModel
{
	...
	public static function InitClasses($sTablePrefix)
	{
		...
		//
		$aInterfaces = array('iPreferencesExtension', 'iLoginExtension', 'iApplicationUIExtension', 'iApplicationObjectExtension', 'iQueryModifier', 'iOnClassInitialization', 'iPopupMenuExtension', 'iPageUIExtension', 'iPortalUIExtension', 'ModuleHandlerApiInterface', 'iNewsroomProvider');
